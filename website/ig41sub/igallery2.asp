...
<%PNAME = "Image and Document Library"
PHELP = "helpFiles/pageListing.asp#library"%>

<!--#INCLUDE Virtual="/admin/headernew.inc"-->

<table border="0" width="760" id="table1" cellpadding="3">
	<tr>
		<td width="209"><!--#INCLUDE FILE="include/menu.asp"--></td>
		<td ><!--#include virtual="/ig41sub/searchform.asp"--></td>
	</tr>
</table>
...
Case 1
%>
<td style="padding: 3px;" <% If Session("userLevel") = "99" OR Session("userLevel") = "98" Then %>width="245"<% Else %>width="155"<% End If %> bgcolor="#f4f4f4" onMouseOver="this.bgColor='#efefef'" onMouseOut="this.bgColor='#f7f7f7'" valign="top" nowrap width="4">&nbsp;</td>
<%
Case 2
%>
