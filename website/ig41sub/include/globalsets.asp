...
'**** Changed to tie into RichTemplate ****

UploadPath 		= strRootPath & "\data\images"

'UploadPath 		= SysRec("UploadPath")

URLPath			= "http://" & strDynPath & "/data/images"
...
Dim SecurityTimeout
SecurityTimeout = 30 'Amount of time idle before security session expires (MIN = 3)
...
Dim GalleryVersion
GalleryVersion = "RichTemplate 2.0"
...
NailerApp = 4
End If
%><!--#include file = "encryption.inc"--><!--#include file = "cropper.inc"--><!--#include file = "emailinc.asp"-->