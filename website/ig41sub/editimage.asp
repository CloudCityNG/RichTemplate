...
<title>.:: <%= GalleryVersion %> Edit Image Properties ::.</title>
...
<%
PNAME = "Image/Document Library - Edit Image Properties"
...
'ADDED  BY JH TO SHOW DESCRIPTIONS FOR ROOT LEVEL IMAGES.
