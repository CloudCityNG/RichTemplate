...
<%
PNAME = "Image/Document Library - Images"
...
<img src="images/folder-open.gif" width=30 height=32 border=0 alt=""></td>
...
<tr>
<td width="22">
<img src="images/sm-uponelevel.gif" width=22 height=23 border=0 alt=""></td>
<td><a class="link" title="Up One Level" href="igallery.asp?d=<%= URLSpace(Parent) %>\"><b><%= IG_uol %></b></a></td>
</tr>
</table>
...
If LCase(fn.Name) = "_vti_cnf" Then
emptyDir = TRUE
ELSE
...
<!--#INCLUDE virtual="/ig41sub/include/paging-ig.asp"-->
...
<img src="images/sm-broken.gif" width="12" height="11" border="0" alt=""></td>
...
<tr>
<td width="16" height="17">
<img src="images/sm-syncimages.gif" width="12" height="11" border="0" alt=""></td>
...
<% Else %>
<td class="textsm"><b><%= IG_cnd2 %>:</b></td>
<% End If %>
</tr>
</table>
</tr>
...
<tr>
<td width="25" nowrap>
<img src="images/sm-upload1.gif" alt="" width="25" height="20" border="0"></td>
...
<table cellspacing="0" cellpadding="0" border="0">
<tr>
<td width="22" nowrap><img src="images/spacer.gif" width="1" height="2"><br>
<a class="linkmed" href="igalery.asp">
<img src="images/sm-return.gif" width="18" height="18" border="0"></a></td>
...
'response.write "newfolderredirect = "&NewFolderRedirect&""
...
NewFolder = Replace(NewFolderRedirect, "\", "&#92")

	nav = "/ig41sub/include/menunew.asp"
    main= "igallery.asp?d="&NewFolder&""
    %>
    <SCRIPT language="JavaScript">
...
NewFolder = Replace(PathCurrent, "\", "&#92")
...
NewFolder = Replace(RenameFolderRedirect, "\", "&#92")
...
Sub JavaRedirect2
	nav = "/ig41sub/include/menunew.asp"
    main="igallery.asp?d="&URLSpace(PathParent)&"/"
    %>
    <SCRIPT language="JavaScript">
