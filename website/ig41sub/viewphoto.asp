...
<title>.:: <%= GalleryVersion %> Photo Viewer ::.</title>
...
<table cellspacing="0" cellpadding="0" border="0">
<tr>
<td class="toolbar" align="center" width="22" height="23" onmouseup="button_up(this)" onmousedown="button_down(this)" onmouseover="button_over(this)" onmouseout="button_out(this)" nowrap><a class="link" onclick="window.close();" href="sendtofriend.asp?i=<%= strimage %>&f=<%= strfolder %>" target="igallery"><img src="images/gallery/email.gif" width=22 height=23 border="0" alt="<%= IGvp_eimg %>"></a></td>
</tr>
</table>
</td>
