<%@ Control Language="VB" AutoEventWireup="false" CodeFile="BlogRepeater.ascx.vb"
    Inherits="Blog_BlogRepeater" %>
<div class="divModuleRepeater">
    <div class="divModuleSortBy">
        <div>
            <%=Resources.Blog_FrontEnd.Blog_BlogRepeater_SortBy%>:
        </div>
        <div class="divModuleSortBy_SortFieldLabel">
            <%=Resources.Blog_FrontEnd.Blog_BlogRepeater_SortBy_Title%>
        </div>
        <div class="divModuleSortBy_Asc">
            <asp:ImageButton ID="imgSortUpTitle" runat="server" ImageUrl="~/images/SquareUp.gif"
                ToolTip="<%$ Resources:Blog_FrontEnd, Blog_BlogRepeater_SortBy_TitleAscending %>" />
        </div>
        <div class="divModuleSortBy_Desc">
            <asp:ImageButton ID="imgSortDownTitle" runat="server" ImageUrl="~/images/SquareDown.gif"
                ToolTip="<%$ Resources:Blog_FrontEnd, Blog_BlogRepeater_SortBy_TitleDescending %>" />
        </div>
        <div class="divModuleSortBy_Seperator">
        </div>
        <div class="divModuleSortBy_SortFieldLabel">
            <%=Resources.Blog_FrontEnd.Blog_BlogRepeater_SortBy_Date%>
        </div>
        <div class="divModuleSortBy_Asc">
            <asp:ImageButton ID="imgSortUpViewDate" runat="server" ImageUrl="~/images/SquareUp.gif"
                ToolTip="<%$ Resources:Blog_FrontEnd, Blog_BlogRepeater_SortBy_DateAscending %>" />
        </div>
        <div class="divModuleSortBy_Desc">
            <asp:ImageButton ID="imgSortDownViewDate" runat="server" ImageUrl="~/images/SquareDown.gif"
                ToolTip="<%$ Resources:Blog_FrontEnd, Blog_BlogRepeater_SortBy_DateDescending %>" />
        </div>
    </div>
    <br class="cBoth" />
    <br />
    <asp:Panel ID="pnlBlog" runat="server">
        <telerik:RadListView ID="rlvBlog" AllowPaging="True" runat="server" AllowSorting="true"
            ItemPlaceholderID="plcHolderBlog" DataKeyNames="blogID">
            <LayoutTemplate>
                <asp:Panel ID="plcHolderBlog" runat="server" />
                ...
                <table cellpadding="0" cellspacing="0" style="clear: both; width: 100%;">
                    ...
                    <tr>
                        <td>
                            <div id="divModuleSearchTagList" runat="server" class="divModuleSearchTagList" visible="false">
                                <br />
                                <%=Resources.Blog_FrontEnd.Blog_BlogRepeater_SearchTagLabel%>:
                    ...
                    <tr>
                        <td>
                            <br />
                            <div class="floatL">
                                <%=Resources.Blog_FrontEnd.Blog_BlogRepeater_PostedBy%>:
                                <%# If(Eval("author_username") Is DbNull.Value, Resources.Blog_FrontEnd.Blog_BlogRepeater_PostedByDefault, Eval("author_username"))%>
                                -
                                <%#Eval("viewdate", "{0:D}")%>
                                <%=Resources.Blog_FrontEnd.Blog_BlogRepeater_PostedBy_DateTimeSeperator%>
                            ...
                            <asp:PlaceHolder ID="plcComments" runat="server" Visible="false">
                                <div class="floatL" runat="server" id="commentLinks">
                                    <asp:HyperLink ID="lnkCommentList" runat="server" NavigateUrl='<%#"Default.aspx?id=" & Eval("blogID") & If(request.querystring("archive") = 1, "&archive=1","") & "#comments"%>'><%=Resources.Blog_FrontEnd.Blog_BlogRepeater_CommentsLabel%> (<%#Eval("commentCount")%>)</asp:HyperLink>
                                    <asp:PlaceHolder ID="plcAddCommentLink" runat="server" Visible="false">&nbsp;|&nbsp;<asp:HyperLink
                                        ID="lnkAddComment" runat="server" NavigateUrl='<%#"Default.aspx?id=" & Eval("blogID") & If(request.querystring("archive") = 1, "&archive=1","") & "#addcomment"%>'><%=Resources.Blog_FrontEnd.Blog_BlogRepeater_CommentsAdd%></asp:HyperLink></asp:PlaceHolder>
                                    &nbsp;|&nbsp;
                                </div>
                            </asp:PlaceHolder>
                            <div class="floatL">
                                <a href="Default.aspx?id=<%#Eval("blogID") %><%# If(request.querystring("archive") = 1, "&archive=1","") %>">
                                    <%=Resources.Blog_FrontEnd.Blog_BlogRepeater_PermanentLabel%></a></div>
                        </td>
                    </tr>
