...
Partial Class MasterPages_RichTemplateMasterPage
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As EventArgs) Handles MyBase.Load
        ...
        If Not Page.IsPostBack Then
            ...
            If Page.Header.Title.Length = 0 Then
                Page.Header.Title = SiteDAL.GetCompanyName() + " | " + Resources.WebInfo_FrontEnd.MasterPage_Public_HeaderTitleDefault
            End If
        ...
        If Not Page.IsPostBack Then
            ...
            If boolShowInMenu Then ' If we allow this row to be shown in the menu we continue
                ...
                If boolUseThreeColumnLayout Then
                    ...
                    Dim iPageLevel As Integer = Convert.ToInt32(DataBinder.Eval(e.Item.DataItem, "PageLevel"))
                ...
                If e.Item.NavigateUrl = "/Home.aspx" Then
                    e.Item.NavigateUrl = "/"
                End If
    ...
    Protected Sub DisplaySubMenu()
        ...
        litLeftMenu.Text = CommonWeb.GetLeftHandSubMenuLinks(PageID, intWebInfoID_Header, intWebInfoID_Footer, boolWebpage_PublicSection_EnableGroupsAndUsers, String.Empty)
