...
Partial Class RichTemplateMasterPage_Members
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As EventArgs) Handles MyBase.Load
        ...
        If Not Page.IsPostBack Then
            ...
            If Page.Header.Title.Length = 0 Then
                Page.Header.Title = SiteDAL.GetCompanyName() + " | " + Resources.WebInfo_FrontEnd.MasterPage_Member_HeaderTitleDefault
            End If
    ...
    Protected Sub LoadRadMenu()
        ...
        If boolUseThreeColumnLayout Then
            dtWebInfoList = If(boolWebpage_MemberSection_EnableGroupsAndUsers, WebInfoDAL.GetWebInfoList_FrontEnd_WithColumLayoutAndAccess(intMaxPageLevel, True, False, MemberDAL.GetCurrentMemberGroupIDs(), intMemberID, intSiteID), WebInfoDAL.GetWebInfoList_FrontEnd_WithColumLayout(intMaxPageLevel, True, False, intSiteID))
        Else
            dtWebInfoList = If(boolWebpage_MemberSection_EnableGroupsAndUsers, WebInfoDAL.GetWebInfoList_FrontEndAndAccess(intMaxPageLevel, True, False, MemberDAL.GetCurrentMemberGroupIDs(), intMemberID, intSiteID), WebInfoDAL.GetWebInfoList_FrontEnd(intMaxPageLevel, True, False, intSiteID))
        End If
    ...
    Protected Sub DisplaySubMenu()

        litLeftMenu.Text = CommonWeb.GetLeftHandSubMenuLinks(PageID, intWebInfoID_Header, intWebInfoID_Footer, boolWebpage_MemberSection_EnableGroupsAndUsers, "member")
