<%@ Control Language="VB" AutoEventWireup="false" CodeFile="EventTreeRepeater.ascx.vb"
    Inherits="Event_EventTreeRepeater" %>
<div class="divModuleRepeater">
    <div class="divModuleSortBy">
        <div>
            <%=Resources.Event_FrontEnd.Event_EventTreeRepeater_SortBy%>:
        </div>
        <div class="divModuleSortBy_SortFieldLabel">
            <%=Resources.Event_FrontEnd.Event_EventTreeRepeater_SortBy_Title%>
        </div>
        <div class="divModuleSortBy_Asc">
            <asp:ImageButton ID="imgSortUpTitle" runat="server" ImageUrl="~/images/SquareUp.gif"
                ToolTip="<%$ Resources:Event_FrontEnd, Event_EventTreeRepeater_SortBy_TitleAscending %>" />
        </div>
        <div class="divModuleSortBy_Desc">
            <asp:ImageButton ID="imgSortDownTitle" runat="server" ImageUrl="~/images/SquareDown.gif"
                ToolTip="<%$ Resources:Event_FrontEnd, Event_EventTreeRepeater_SortBy_TitleDescending %>" />
        </div>
        <div class="divModuleSortBy_Seperator">
        </div>
        <div class="divModuleSortBy_SortFieldLabel">
            <%=Resources.Event_FrontEnd.Event_EventTreeRepeater_SortBy_Date%>
        </div>
        <div class="divModuleSortBy_Asc">
            <asp:ImageButton ID="imgSortUpStartDate" runat="server" ImageUrl="~/images/SquareUp.gif"
                ToolTip="<%$ Resources:Event_FrontEnd, Event_EventTreeRepeater_SortBy_DateAscending %>" />
        </div>
        <div class="divModuleSortBy_Desc">
            <asp:ImageButton ID="imgSortDownStartDate" runat="server" ImageUrl="~/images/SquareDown.gif"
                ToolTip="<%$ Resources:Event_FrontEnd, Event_EventTreeRepeater_SortBy_DateDescending %>" />
        </div>
    </div>
    <br class="cBoth" />
    <br />
    <asp:Panel ID="pnlEvent" runat="server" Width="100%">
        <telerik:RadListView ID="rlvEvent" Width="97%" AllowPaging="True" runat="server"
            allowsorting="true" ItemPlaceholderID="plcHolderEvent" DataKeyNames="eventID">
            <LayoutTemplate>
                <asp:Panel ID="plcHolderEvent" runat="server" Width="100%" />
                ...
                <table cellpadding="0" cellspacing="0" class="cBoth" style="width: 100%;">
                    ...
                    <tr>
                        <td>
                            <div id="divModuleSearchTagList" runat="server" class="divModuleSearchTagList" visible="false">
                                <br />
                                <%=Resources.Event_FrontEnd.Event_EventTreeRepeater_SearchTagLabel%>:
                    ...
                    <tr>
                        <td>
                            <br />
                            <div class="floatL">
                                <%=Resources.Event_FrontEnd.Event_EventTreeRepeater_PostedBy%>:
                                <%# If(Eval("author_username") Is DBNull.Value, Resources.Event_FrontEnd.Event_EventTreeRepeater_PostedByDefault, Eval("author_username"))%>
                                -
                                <%#Eval("viewdate", "{0:D}")%>
                                <%=Resources.Event_FrontEnd.Event_EventTreeRepeater_PostedBy_DateTimeSeperator%>
                            ...
                            <asp:PlaceHolder ID="plcComments" runat="server" Visible="false">
                                <div class="floatL" runat="server" id="commentLinks">
                                    <asp:HyperLink ID="lnkCommentList" runat="server" NavigateUrl='<%#"Default.aspx?id=" & Eval("eventID") & If(request.querystring("archive") = 1, "&archive=1","") & "#comments"%>'><%=Resources.Event_FrontEnd.Event_EventTreeRepeater_CommentsLabel%> (<%#Eval("commentCount")%>)</asp:HyperLink>
                                    <asp:PlaceHolder ID="plcAddCommentLink" runat="server" Visible="false">&nbsp;|&nbsp;<asp:HyperLink
                                        ID="lnkAddComment" runat="server" NavigateUrl='<%#"Default.aspx?id=" & Eval("eventID") & If(request.querystring("archive") = 1, "&archive=1","") & "#addcomment"%>'><%=Resources.Event_FrontEnd.Event_EventTreeRepeater_CommentsAdd%> </asp:HyperLink></asp:PlaceHolder>
                                    &nbsp;|&nbsp;
                                </div>
                            </asp:PlaceHolder>
                            <asp:PlaceHolder ID="plcOnlineSignup" runat="server" Visible="false">
                                <div class="floatL">
                                    <a href='<%#"Default.aspx?id=" & Eval("eventID") & "#signup"%>'>
                                        <%=Resources.Event_FrontEnd.Event_EventTreeRepeater_ApplyNowLabel%></a>&nbsp;|&nbsp;
                                </div>
                            </asp:PlaceHolder>
                            <div class="floatL">
                                <a href="<%# If(Not Eval("externalLinkUrl") Is DBNull.Value AndAlso Eval("externalLinkUrl").Length > 0, Eval("externalLinkUrl"), "Default.aspx?id=" & Eval("eventID") & If(request.querystring("archive") = 1, "&archive=1","") ) %>">
                                    <%=Resources.Event_FrontEnd.Event_EventTreeRepeater_PermanentLabel%></a></div>
                        </td>
                    </tr>
