	...
	for(var i=0;i<this.buttonMap.length;i++)
		...
		switch(sButtonName)
			...
			case "Bookmark":
				...
				break;
			case "Hyperlink":
				if(this.btnHyperlink)sHTMLIcons+=this.writeIconStandard("btnHyperlink"+this.oName,this.oName+".hide();modelessDialogShow('"+this.scriptPath+"hyperlink.asp',380,200)","btnHyperlink.gif",getTxt("Hyperlink"));
				break;
			case "CustomTag":
		...
		for(var i=0;i<allSpans.length;i++)
			...
			if (oSel.inRange(tempRange))
				{//tdk perlu ada +/- (krn optionnya tdk ada)
				    ...
				    if (val == 1) allSpans[i].style.fontSize = ".7em";
				    else if (val == 2) allSpans[i].style.fontSize = ".8em";
				    else if (val == 3) allSpans[i].style.fontSize = "1em";
				    else if (val == 4) allSpans[i].style.fontSize = "1.2em";
				    else if (val == 5) allSpans[i].style.fontSize = "1.5em";
				    else if (val == 6) allSpans[i].style.fontSize = "2em";
				    else if (val = 7) allSpans[i].style.fontSize = "3em";
				}
			}
		}
...
function copyAttribute(newSpan,f)
	...
	if((f.size!=null)&&(f.size!=""))
	    ...
	    if(f.size==1)nSize=".7em";
		else if(f.size==2)nSize=".8em";
		else if(f.size==3)nSize="1em";
		else if(f.size==4)nSize="1.2em";
		else if(f.size==5)nSize="1.5em";
		else if(f.size==6)nSize="2em";
		else if(f.size>=7)nSize="3em";
		else if(f.size<=-2||f.size=="0")nSize=".7em";
		else if(f.size=="-1")nSize=".8em";
		else if(f.size==0)nSize="1em";
		else if(f.size=="+1")nSize="1.2em";
		else if(f.size=="+2")nSize="1.5em";
		else if(f.size=="+3")nSize="2em";
		else if(f.size=="+4"||f.size=="+5"||f.size=="+6")nSize="3em";
		else nSize="";
