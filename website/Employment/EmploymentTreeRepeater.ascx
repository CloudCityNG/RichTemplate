<%@ Control Language="VB" AutoEventWireup="false" CodeFile="EmploymentTreeRepeater.ascx.vb"
    Inherits="Employment_EmploymentTreeRepeater" %>
<div class="divModuleRepeater">
    <div class="divModuleSortBy">
        <div>
            <%=Resources.Employment_FrontEnd.Employment_EmploymentTreeRepeater_SortBy%>:
        </div>
        <div class="divModuleSortBy_SortFieldLabel">
            <%=Resources.Employment_FrontEnd.Employment_EmploymentTreeRepeater_SortBy_Title%>
        </div>
        <div class="divModuleSortBy_Asc">
            <asp:ImageButton ID="imgSortUpTitle" runat="server" ImageUrl="~/images/SquareUp.gif"
                ToolTip="<%$ Resources:Employment_FrontEnd, Employment_EmploymentTreeRepeater_SortBy_TitleAscending %>" />
        </div>
        <div class="divModuleSortBy_Desc">
            <asp:ImageButton ID="imgSortDownTitle" runat="server" ImageUrl="~/images/SquareDown.gif"
                ToolTip="<%$ Resources:Employment_FrontEnd, Employment_EmploymentTreeRepeater_SortBy_TitleDescending %>" />
        </div>
        <div class="divModuleSortBy_Seperator">
        </div>
        <div class="divModuleSortBy_SortFieldLabel">
            <%=Resources.Employment_FrontEnd.Employment_EmploymentTreeRepeater_SortBy_Date%>
        </div>
        <div class="divModuleSortBy_Asc">
            <asp:ImageButton ID="imgSortUpViewDate" runat="server" ImageUrl="~/images/SquareUp.gif"
                ToolTip="<%$ Resources:Employment_FrontEnd, Employment_EmploymentTreeRepeater_SortBy_DateAscending %>" />
        </div>
        <div class="divModuleSortBy_Desc">
            <asp:ImageButton ID="imgSortDownViewDate" runat="server" ImageUrl="~/images/SquareDown.gif"
                ToolTip="<%$ Resources:Employment_FrontEnd, Employment_EmploymentTreeRepeater_SortBy_DateDescending %>" />
        </div>
    </div>
    <br class="cBoth" />
    <br />
    <asp:Panel ID="pnlEmployment" runat="server" Width="100%">
        <telerik:RadListView ID="rlvEmployment" Width="97%" AllowPaging="True" runat="server"
            allowsorting="true" ItemPlaceholderID="plcHolderEmployment" DataKeyNames="employmentID">
            <LayoutTemplate>
                <asp:Panel ID="plcHolderEmployment" runat="server" Width="100%" />
                ...
                <table cellpadding="0" cellspacing="0" class="cBoth" style="width: 100%;">
                    ...
                    <tr>
                        <td>
                            ...
                            <div id="divSalaryRange" runat="server" visible="false" class="clear">
                                <b>
                                    <%=Resources.Employment_FrontEnd.Employment_EmploymentTreeRepeater_Salary%></b>:
                            ...
                            <div id="divClearance" runat="server" visible="false" class="clear">
                                <b>
                                    <%=Resources.Employment_FrontEnd.Employment_EmploymentTreeRepeater_Clearance%></b>:
                                <asp:Literal ID="litClearance" runat="server" />
                            </div>
                            <div id="divContactPerson" runat="server" visible="false" class="clear">
                                <b>
                                    <%=Resources.Employment_FrontEnd.Employment_EmploymentTreeRepeater_ContactPerson %></b>:
                    ...
                    <tr>
                        <td>
                            <div id="divModuleSearchTagList" runat="server" class="divModuleSearchTagList" visible="false">
                                <br />
                                <%=Resources.Employment_FrontEnd.Employment_EmploymentTreeRepeater_SearchTagLabel%>:
                    ...
                    <tr>
                        <td>
                            <br />
                            <div class="floatL">
                                <%=Resources.Employment_FrontEnd.Employment_EmploymentTreeRepeater_PostedBy%>:
                                <%# If(Eval("author_username") Is DBNull.Value, Resources.Employment_FrontEnd.Employment_EmploymentTreeRepeater_PostedByDefault, Eval("author_username"))%>
                                -
                                <%#Eval("viewdate", "{0:D}")%>
                                <%=Resources.Employment_FrontEnd.Employment_EmploymentTreeRepeater_PostedBy_DateTimeSeperator%>
                            ...
                            <asp:PlaceHolder ID="plcOnlineSignup" runat="server" Visible="false">
                                <div class="floatL">
                                    <a href='<%#"Default.aspx?id=" & Eval("employmentID") & "#signup"%>'>
                                        <%=Resources.Employment_FrontEnd.Employment_EmploymentTreeRepeater_ApplyNowLabel%></a>&nbsp;|&nbsp;
                                </div>
                            </asp:PlaceHolder>
                            <div class="floatL">
                                <a href="<%# If(Not Eval("externalLinkUrl") Is DBNull.Value AndAlso Eval("externalLinkUrl").Length > 0, Eval("externalLinkUrl"), "Default.aspx?id=" & Eval("employmentID") & If(request.querystring("archive") = 1, "&archive=1","") ) %>">
                                    <%=Resources.Employment_FrontEnd.Employment_EmploymentTreeRepeater_PermanentLabel%></a></div>
                        </td>
                    </tr>
