...
Partial Class Poll_PollCategoryListing
    ...
    Private Sub getCategories()
        ...
        'Check we need to show the poll RSS FEED, only show if we are showing active records
        ...
        Dim dtCategory As DataTable = If(boolEnableGroupsAndUserAccess, CategoryDAL.GetCategoryList_WithCount_ByModuleTypeIDAndStatusAndAccess(ModuleTypeID, intSiteID, True, "ID", "PublicationDate", "ExpirationDate", MemberDAL.GetCurrentMemberGroupIDs(), intMemberID), CategoryDAL.GetCategoryList_WithCount_ByModuleTypeIDAndStatus(ModuleTypeID, intSiteID, True, "PublicationDate", "ExpirationDate"))
    ...
    Protected Sub catRepeater_ItemDataBound(ByVal sender As Object, ByVal e As RepeaterItemEventArgs) Handles catRepeater.ItemDataBound
        If ((e.Item.ItemType = ListItemType.Item) Or (e.Item.ItemType = ListItemType.AlternatingItem)) Then
            ...
            'Check we need to show the poll RSS FEED
            If boolShowRssFeed Then
                e.Item.FindControl("rssPoll").Visible = True
            End If
        ...
        If e.Item.ItemType = ListItemType.Footer Then
            ...
            Dim dtPoll_Uncategorized As DataTable = If(boolEnableGroupsAndUserAccess, PollDAL.GetPoll_ByCategoryNullAndStatusAndAccess_FrontEnd(True, MemberDAL.GetCurrentMemberGroupIDs(), intMemberID, intSiteID), PollDAL.GetPoll_ByCategoryNullAndStatus_FrontEnd(True, intSiteID))
