...
<%@ Control Language="VB" AutoEventWireup="false" CodeFile="StaffDetail.ascx.vb"
    Inherits="staff_StaffDetail" %>
<div class="divDirStaffHead">
    ...
    <div class="floatR">
        <a class="moduleViewAll" href='<%= If(Not Request.Params("archive") Is Nothing AndAlso Convert.ToInt32(Request.Params("archive")) = 1, "Default.aspx?archive=1", "Default.aspx")%>'>
            (<%= Resources.Staff_FrontEnd.Staff_StaffDetail_ViewAllStaffMembers%>)</a>
    </div>
</div>
<br class="clear" />
<br />
