...
<script src="demoFramesetNodes.asp"></script>
...
<img border="0" src="images/icon_addpage.gif" width="16" height="16"></td>
				<td>
				<% If Request.Querystring("secure_education") = "yes" Then %>
				    <font color="#800000">
				        <b>
				            <a target="basefrm" href="/admin/richtemplate_page_editor.aspx?secure_education=yes">
				                <font color="#408FE3">Add a New Section</font>
				            </a>
				        </b>
				    </font>
				    <% ElseIf Request.Querystring("secure_members") = "yes" Then %>
				    <font color="#800000">
				        <b>
				            <a target="basefrm" href="/admin/richtemplate_page_editor.aspx?secure_members=yes">
				                <font color="#408FE3">Add a New Section</font>
				            </a>
				        </b>
				    </font>
				    ...
				    <font color="#800000">
				        <b>
				            <a target="basefrm" href="/admin/richtemplate_page_editor.aspx">
				                <font color="#408FE3">Add a New Section</font>
				            </a>
				        </b>
				    </font>
