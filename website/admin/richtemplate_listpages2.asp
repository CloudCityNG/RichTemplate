...
WEBSECTIONSQL = "SELECT  * FROM WEBINFO WHERE ID="&REQUEST.QUERYSTRING("SECTIONID")&" AND PAGELEVEL = 1 ORDER BY DEFAULTPAGE DESC, RANK"
...
<b>Add sub-page</b></td>
    ...
    <%IF RS("DEFAULTPAGE")= TRUE THEN
    	defaultpage=-1%>
    	<td  bgcolor="<%=bgcolor%>" style="border-left-width: 1px; border-right-width: 1px; border-top-width: 1px; border-bottom: 1px solid #D2E3FC; " width="50%"><img border="0" src="images/icon_root_page.gif" width="16" height="16"><font color="#FF0000"> Root (<%=RS("NAME")%>)</font></td>
...
<%
getTags = "Select * from tagXref where recordID = "&RS("ID")&""
set tagRS = con.execute(getTags)
If tagRS.EOF then%>
<a href="/admin/tagsmodule/searchTags.asp?recordID=<%=RS("ID")%>&sectionid=<%=REQUEST.QUERYSTRING("SECTIONID")%>&recordType=webpage">Add</a>
<%Else%>
<a href="/admin/tagsmodule/searchTags.asp?recordID=<%=RS("ID")%>&sectionid=<%=REQUEST.QUERYSTRING("SECTIONID")%>&recordType=webpage">Edit</a>
<%End If%>
</td>
<%end if%>
...
<%IF RS("LINKONLY")<> TRUE and RS("message") <> "" THEN%>
...
<%END IF%>
	...
	<td width="30" class=body bgcolor ="<%=bgcolor%>" style="border-left-width: 1px; border-right-width: 1px; border-top-width: 1px; border-bottom: 1px solid #D2E3FC; "><a href="javascript:confirmdelete2('richtemplate_page_logic.asp?task=deletesection&SECTIONID=<%=Request.Querystring("SectionID")%>')">
		Delete</a>
</td>	
			     ...
			     <%
					...
					<TR><td bgcolor ="<%=bgcolor%>" style='border-left-width: 1px; border-right-width: 1px; border-top-width: 1px; border-bottom: 1px solid #D2E3FC;' width="50%">&nbsp;&nbsp;&nbsp;<img border='0' src='images/icon_subpage.gif' width='16' height='16'><font color='#3055A9' >&nbsp;<%=RS2("NAME")%><%If RS2("linkonly")= TRUE THEN
					RESPONSE.WRITE" - (Link)"
					END IF%>
</FONT></td>
...
<%
getTags = "Select * from tagXref where recordID = "&RS2("ID")&""
set tagRS = con.execute(getTags)
If tagRS.EOF then%>
<a href="/admin/tagsmodule/searchTags.asp?recordID=<%=RS2("ID")%>&sectionid=<%=REQUEST.QUERYSTRING("SECTIONID")%>&recordType=webpage">Add</a>
<%Else%>
<a href="/admin/tagsmodule/searchTags.asp?recordID=<%=RS2("ID")%>&sectionid=<%=REQUEST.QUERYSTRING("SECTIONID")%>&recordType=webpage">Edit</a>
<%End If%>
</td>
<%end if%>					
					<td width="20" class=style1 bgcolor ="<%=bgcolor%>" style="border-left-width: 1px; border-right-width: 1px; border-top-width: 1px; border-bottom: 1px solid #D2E3FC; ">
			...
			<img border="0" src="images/downarrow.gif" alt="move down"></a></td>
            		...
            		<td width="50" class=style1 valign="middle" bgcolor ="<%=bgcolor%>" style="border-left-width: 1px; border-right-width: 1px; border-top-width: 1px; border-bottom: 1px solid #D2E3FC; ">
<%IF RS2("LINKONLY")<> TRUE and RS2("message") <> "" THEN%>
...
<%
getTags = "Select * from tagXref where recordID = "&RS3("ID")&""
set tagRS = con.execute(getTags)
If tagRS.EOF then%>
<a href="/admin/tagsmodule/searchTags.asp?recordID=<%=RS3("ID")%>&sectionid=<%=REQUEST.QUERYSTRING("SECTIONID")%>&recordType=webpage">Add</a>
<%Else%>
<a href="/admin/tagsmodule/searchTags.asp?recordID=<%=RS3("ID")%>&sectionid=<%=REQUEST.QUERYSTRING("SECTIONID")%>&recordType=webpage">Edit</a>
<%End If%>
</td>
<%end if%>					
					<td width="20" class=style1 bgcolor ="<%=bgcolor%>" style="border-left-width: 1px; border-right-width: 1px; border-top-width: 1px; border-bottom: 1px solid #D2E3FC; ">
			...
			<img border="0" src="images/downarrow.gif" alt="move down"></a></td>
            		...
            		<td width="50" class=style1 valign="middle" bgcolor ="<%=bgcolor%>" style="border-left-width: 1px; border-right-width: 1px; border-top-width: 1px; border-bottom: 1px solid #D2E3FC; ">
<%IF RS3("LINKONLY")<> TRUE and RS3("message") <> "" THEN%>
...
<%END IF%>				
	...
	<td width="30" class=body bgcolor ="<%=bgcolor%>" style="border-left-width: 1px; border-right-width: 1px; border-top-width: 1px; border-bottom: 1px solid #D2E3FC; ">
<%IF SESSION("ALLOW_PAGEDELETE")= TRUE THEN%>	
    <a href="javascript:confirmdelete('richtemplate_page_logic.asp?task=delete&pageID=<%=RS3("ID")%>&sectionid=<%=REQUEST.QUERYSTRING("sectionid")%>')" >Delete</a></td>
<%end if%>
	</td>
...
<%If tagModActive = True then%>
            		...
            		<td width='50%' bgcolor ="<%=bgcolor%>" style='border-left-width: 1px; border-right-width: 1px; border-top-width: 1px; border-bottom: 1px solid #D2E3FC;'>
						&nbsp;</td>
...
<%end if%>					
			...
			<img border="0" src="images/downarrow.gif" alt="move down"></a></td>
            		...
            		<td width="50" class=style1 valign="middle" bgcolor ="<%=bgcolor%>" style="border-left-width: 1px; border-right-width: 1px; border-top-width: 1px; border-bottom: 1px solid #D2E3FC; ">
<%IF RS4("LINKONLY")<> TRUE  and RS4("message") <> ""THEN%>
...
<%
getTags = "Select * from tagXref where recordID = "&RS4("ID")&""
set tagRS = con.execute(getTags)
If tagRS.EOF then%>
<a href="/admin/tagsmodule/searchTags.asp?recordID=<%=RS4("ID")%>&sectionid=<%=REQUEST.QUERYSTRING("SECTIONID")%>&recordType=webpage">Add</a>
<%Else%>
<a href="/admin/tagsmodule/searchTags.asp?recordID=<%=RS4("ID")%>&sectionid=<%=REQUEST.QUERYSTRING("SECTIONID")%>&recordType=webpage">Edit</a>
<%End If%>
</td>
<%end if%>
					<td width="20" class=style1 bgcolor ="<%=bgcolor%>" style="border-left-width: 1px; border-right-width: 1px; border-top-width: 1px; border-bottom: 1px solid #D2E3FC; ">
...
<%IF RS5("LINKONLY")<> TRUE  and RS5("message") <> ""THEN%>
...
<%END IF%>
    ...
    <td width="30" class=body bgcolor ="<%=bgcolor%>" style="border-left-width: 1px; border-right-width: 1px; border-top-width: 1px; border-bottom: 1px solid #D2E3FC; ">
<%IF SESSION("ALLOW_PAGEDELETE")= TRUE THEN%>	
    <a href="javascript:confirmdelete('richtemplate_page_logic.asp?task=delete&pageID=<%=RS5("ID")%>&sectionid=<%=REQUEST.QUERYSTRING("sectionid")%>')" >Delete</a></td>
<%end if%>
	</td>
...
<%
getTags = "Select * from tagXref where recordID = "&RS5("ID")&""
set tagRS = con.execute(getTags)
If tagRS.EOF then%>
<a href="/admin/tagsmodule/searchTags.asp?recordID=<%=RS5("ID")%>&sectionid=<%=REQUEST.QUERYSTRING("SECTIONID")%>&recordType=webpage">Add</a>
<%Else%>
<a href="/admin/tagsmodule/searchTags.asp?recordID=<%=RS5("ID")%>&sectionid=<%=REQUEST.QUERYSTRING("SECTIONID")%>&recordType=webpage">Edit</a>
<%End If%>
</td>
<%end if%>
					<td width="20" class=style1 bgcolor ="<%=bgcolor%>" style="border-left-width: 1px; border-right-width: 1px; border-top-width: 1px; border-bottom: 1px solid #D2E3FC; ">
            ...
            <td width="50" class=style1 valign="middle" bgcolor ="<%=bgcolor%>" style="border-left-width: 1px; border-right-width: 1px; border-top-width: 1px; border-bottom: 1px solid #D2E3FC; ">
<%IF RS6("LINKONLY")<> TRUE  and RS6("message") <> ""THEN%>
