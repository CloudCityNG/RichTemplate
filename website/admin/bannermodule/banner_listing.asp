...
PHELP = "../helpFiles/bannerRotator.asp"
%>
...
%>
    ...
    <%IF RS("DEFAULTPAGE")= TRUE THEN
		...
		<img border="0" src="../images/icon_root_page.gif" width="16" height="16"></td>
      	<td width="168"bgcolor ="<%=bgcolor%>" class=bodybold style="border-left-width: 1px; border-right-width: 1px; border-top-width: 1px; border-bottom: 1px solid #D2E3FC; " align="left"><font color="#FF0000">Default (<%=RS("NAME")%>)</font></td>
         <td width="732" class=body bgcolor ="<%=bgcolor%>" style="border-left-width: 1px; border-right-width: 1px; border-top-width: 1px; border-bottom: 1px solid #D2E3FC; ">
...
<%END IF%>
			     ...
			     <%
					...
					<td width='168' class=bodybold bgcolor ="<%=bgcolor%>" style='border-left-width: 1px; border-right-width: 1px; border-top-width: 1px; border-bottom: 1px solid #D2E3FC;' align="left"><font color='#3055A9' >
					&nbsp;&nbsp;&nbsp;<%=RS2("NAME")%></FONT></td>
